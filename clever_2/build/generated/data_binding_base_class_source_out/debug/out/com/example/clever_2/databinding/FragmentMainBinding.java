...
public final class FragmentMainBinding implements ViewBinding {
  ...
  private FragmentMainBinding(@NonNull FrameLayout rootView, @NonNull RecyclerView recyclerView) {
  ...
  public static FragmentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMainBinding((FrameLayout) rootView, recyclerView);
    }
